...
class CURLRequest {
	...
	protected function initCURL()
	{
		if( ! function_exists('curl_version')) {
			throw new CURLRequestException('cURL mevcut değil.', 501);
		}
	...
	{
		if(empty($url)) {
			throw new CURLRequestException('URL gerekli.', 400);
		}
	...
	{
		if( ! is_int($timeout)) {
			throw new CURLRequestException('Zaman aşımı bir tamsayı olmalıdır.', 400);
		}
