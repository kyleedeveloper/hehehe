...
{
alert("Yeni Parola ve Parolayı Onayla Alanı eşleşmiyor !!");
...
<center>
<img class="rounded-circle header-profile-user" src="assets/images/ded/ded.png" alt="Header Avatar" height="40">
<br><br>
