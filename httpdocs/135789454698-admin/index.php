                                ...
                                <div class="p-2">
                                        <div class="form-group">
                                          <form class="user" method="POST">
                                           ...
                                           <input type="text-s" name="username" class="form-control form-control-user" placeholder="Kullanıcı Adınızı giriniz">
                                        </div>
                
                                        <div class="form-group">
                                            <label for="userpassword">Şifre</label>
                                            <input type="password" name="password" class="form-control form-control-user" placeholder="Şifrenizi giriniz">
                                        </div>
