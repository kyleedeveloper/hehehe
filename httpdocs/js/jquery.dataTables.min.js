...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": sütunu artan şekilde sıralamak için etkinleştir",sSortDescending:": sütunu azalan sıralamak için etkinleştir"},oPaginate:{sFirst:"Öncelikle",sLast:"Geçen",sNext:"İleri",sPrevious:"Previous"},sEmptyTable:"Tabloda veri yok",sInfo:"Göserilen _START_ to _END_ of _TOTAL_ girdileri",sInfoEmpty:"Gösterilen 0 to 0 of 0 girdileri",
sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Gösteren _MENU_ girdileri",sLoadingRecords:"Yükleniyor...",sProcessing:"İşleme...",sSearch:"Search:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Hiçbir eşleşen kayıt bulunamadı"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
